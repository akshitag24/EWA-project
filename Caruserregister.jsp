...
<h2 style="color:DarkSlateGray;text-align:center;font-size:300%">Car User Registration</h2>
<h3 style="text-align:center;color:Green">Enter the information to register to carzoz as user</h3>
<form action="CarUserRegister" method="post" style="text-align:center;color:DarkSlateBlue;font-size:100%">
