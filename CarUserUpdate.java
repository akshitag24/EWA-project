 ...
 */
//@WebServlet("Register")
public class CarUserUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       int u =0;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CarUserUpdate() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	       ...
	       //step - 3
			...
			String query = "update userdata set Fname = '"+Fname1+"' , Lname='"+Lname1+"' , City='"+city+"' , State='"+state+"' , Password='"+pass1+"' where UserId='"+user1+"'";
			try {
			...
			if(u==0)
			{
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("/CarUserLogin.jsp");
